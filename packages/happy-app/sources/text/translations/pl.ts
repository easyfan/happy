...
export const pl: TranslationStructure = {
    ...
    settingsLanguage: {
        ...
        restartRequiredMessage: 'Uruchom ponownie aplikację, aby zmiana języka weszła w życie.',
    },
    ...
    modals: {
        ...
        invalidServerUrl: 'Nieprawidłowy adres URL serwera w kodzie QR',
    },
    ...
    fileShare: {
        ...
        filesPdfTxt: 'Pliki (PDF, TXT, Word, Excel, PowerPoint)',
