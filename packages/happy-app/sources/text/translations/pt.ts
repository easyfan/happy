...
export const pt: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        resumeSessionNotTracked: 'Esta sessão foi iniciada por um processo que já não está em execução, portanto não pode ser retomada neste computador.',
    ...
    fileShare: {
        ...
        tooManyFilesTitle: 'Arquivos demais',
        tooManyFiles: ({ count }: { count: number }) => `Você pode anexar no máximo ${count} arquivos`,
        moreFiles: ({ count }: { count: number }) => `+${count} mais`,
    },
