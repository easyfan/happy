...
export const pt: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        resumeSessionUnknownError: 'A retomada falhou com uma resposta inesperada. Por favor, tente novamente.',
    ...
    settingsLanguage: {
        ...
        restartRequiredMessage: 'Reinicie o aplicativo para que a alteração de idioma entre em vigor.',
    },
    ...
    fileShare: {
        ...
        deviceOfflineWarning: 'Dispositivo offline. Arquivo salvo, será entregue quando o CLI reconectar.',
    },

    permissions: {
        handledOnAnotherDevice: 'Tratado em outro dispositivo',
        actionFailed: 'A a\xe7\xe3o falhou. Tente novamente.',
    },
