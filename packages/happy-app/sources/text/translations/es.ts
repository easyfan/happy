...
export const es: TranslationStructure = {
    ...
    settingsLanguage: {
        ...
        restartRequiredMessage: 'Reinicia la aplicación para que el cambio de idioma surta efecto.',
    },
    ...
    modals: {
        ...
        invalidServerUrl: 'URL de servidor inválida en el código QR',
    },
    ...
    permissions: {
        ...
        actionFailed: 'La acci\xf3n ha fallado. Int\xe9ntelo de nuevo.',
    },
