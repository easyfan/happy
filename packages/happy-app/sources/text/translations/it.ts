...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'Happy Coder è un client mobile per Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
    ...
    modals: {
        ...
        invalidServerUrl: 'URL del server non valido nel codice QR',
    },
    ...
    fileShare: {
        ...
        filesPdfTxt: 'File (PDF, TXT, Word, Excel, PowerPoint)',
